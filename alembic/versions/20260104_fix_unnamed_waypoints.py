"""Fix unnamed accommodation waypoints with nearest settlement name.

This is a re-run of the update logic in case migration 006 failed.
...
def upgrade() -> None:
    ...
    # Get unnamed accommodations (that don't already have a location suffix)
